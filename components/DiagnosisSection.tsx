...
export function DiagnosisSection({
  ...
  return (
    <div className="rounded-2xl border border-[var(--card-border)] border-l-2 border-l-purple-500/40 bg-[var(--card-bg)] overflow-hidden hover:shadow-lg hover:-translate-y-px transition-all duration-200" style={{ boxShadow: 'var(--card-shadow)' }}>
