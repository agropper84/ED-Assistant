...
export function ReferralModal({ isOpen, onClose, rowIndex, sheetName, onGenerated }: ReferralModalProps) {
  ...
  const urgencyOptions = [
    { value: 'routine' as const, label: 'Routine', color: 'bg-green-100 text-green-800 border-green-300' },
    { value: 'urgent' as const, label: 'Urgent', color: 'bg-amber-100 text-amber-800 border-amber-300' },
    { value: 'emergent' as const, label: 'Emergent', color: 'bg-red-100 text-red-800 border-red-300' },
  ];
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-end sm:items-center justify-center">
      <div className="bg-white w-full sm:max-w-lg sm:rounded-2xl rounded-t-2xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b">
          <h2 className="text-lg font-semibold">Generate Referral</h2>
